                ...
                <form action="{{ route('service.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="subtitle" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter subtitle">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input name="quality_servicing" class="custom-control-input" type="checkbox" id="customCheckbox1">
                        <label for="customCheckbox1" class="custom-control-label">Quality Servicing</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input name="expert_workers" class="custom-control-input" type="checkbox" id="customCheckbox2">
                        <label for="customCheckbox2" class="custom-control-label">Expert Workers</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input name="modern_equipment" class="custom-control-input" type="checkbox" id="customCheckbox3">
